...
public class LogApplicationService {
     ...
     */
    public ApiResult routeLog(String studentNumber, LogAction logAction, LocalDateTime logTime) {
     ...
     */
    private ApiResult attendanceLog(String studentNumber, LocalDateTime attendTime) {
        ...
        return new ApiResult(true, message, attendanceCycle);
    }
     ...
     */
    private ApiResult leaveLog(String studentNumber, LocalDateTime leaveTime) {
     ...
     */
    private ApiResult outingLog(String studentNumber, LocalDateTime outingTime, LogAction logAction) {
        ...
        return new ApiResult(true, message, outingCycle);
    }
     ...
     */
    private ApiResult returnLog(String studentNumber, LocalDateTime returnTime) {
